...
export const RESOURCE_COLORS: Record<Resource, TileColorType> = {
  BRICK: TILE_COLORS.BRICKYARD,
  ORE: TILE_COLORS.QUARRY,
  WOOD: TILE_COLORS.FORREST,
  WHEAT: TILE_COLORS.FIELD,
  SHEEP: TILE_COLORS.PLAINS,
  "": TILE_COLORS.DESERT,
};

export const DEFAULT_TILES: Resource[] = [
  "WHEAT",
  "WOOD",
  "SHEEP",
  "BRICK",
...
export const DEFAULT_HEXES: Record<string, HexSvgInfo> = {
  ...
  "2": {
    ...
    adjacentVertices: ["2", "6", "10", "14", "9", "5"],
  },
  "3": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["7", "12", "17", "22", "16", "11"],
  },
  "4": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["8", "13", "18", "23", "17", "12"],
  },
  "5": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["9", "14", "19", "24", "18", "13"],
  },
  "6": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["10", "15", "20", "25", "19", "14"],
  },
  "7": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["16", "22", "28", "33", "27", "21"],
  },
  "8": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["17", "23", "29", "34", "28", "22"],
  },
  "9": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["18", "24", "30", "35", "29", "23"],
  },
  "10": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["19", "25", "31", "36", "30", "24"],
  },
  "11": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["20", "26", "32", "37", "31", "25"],
  },
  "12": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["28", "34", "39", "43", "38", "33"],
  },
  "13": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["29", "35", "40", "44", "39", "34"],
  },
  "14": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["30", "36", "41", "45", "40", "35"],
  },
  "15": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["31", "37", "42", "46", "41", "36"],
  },
  "16": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["39", "44", "48", "51", "47", "43"],
  },
  "17": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["40", "45", "49", "52", "48", "44"],
  },
  "18": {
    pathInfo: {
      d: "M116.22 106.995 51.143 144.69l-65.181-37.51-.106-75.203L50.932-5.718l65.181 37.51Z",
    ...
    adjacentVertices: ["41", "46", "50", "53", "49", "45"],
  },
};
